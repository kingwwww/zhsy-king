 ...
 */
public class StoreFailedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_store_failed, container, false);
        mRecyclerOrder = (RecyclerView) v.findViewById(R.id.order_failed);
        ...
        orderModel.setOrderTag(OrderModel.SELECT_FAILED_ORDER);
    ...
    private class OrderAdapter extends RecyclerView.Adapter<OrderHolder>{
        ...
        public void onBindViewHolder(final OrderHolder holder, int position) {
            ...
            holder.mTextStatus.setText("已取消");
